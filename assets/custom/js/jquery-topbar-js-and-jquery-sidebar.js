...
var ConsoleTopbar = function () {
  function ConsoleTopbar() {
    ...
    this.config = window.TOPBAR_CONFIG || {
      beforeRenderDataCallback: null,
      afterRenderDomCallback: null
    };
    this.scope = {};
  }
  ...
  ConsoleTopbar.prototype.dataRequest = function dataRequest(container) {
    ...
    $.ajax({
      ...
      if (result && result.code == "200") {
        ...
        if (config && config.beforeRenderDataCallback) {
          data = config.beforeRenderDataCallback(data) || data;
        }
        directiveLink(container, data);
        if (config && config.afterRenderDomCallback) {
          config.afterRenderDomCallback(container);
        }
      }
...
var ConsoleSidebar = function () {
  function ConsoleSidebar() {
    ...
    this.config = window.SIDEBAR_CONFIG || {
      forceFolding: false,
      productId: null,
      beforeRenderDataCallback: null,
      afterRenderDomCallback: null
